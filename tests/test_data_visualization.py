import pickle
import pytest
from timexseries_clustering.data_visualization import create_timeseries_dash_children

from timexseries_clustering.data_clustering import create_timeseries_containers
